...
public class Main {
	public static void main(String[] args) throws IOException {
        ...
        */
        ...
        System.out.println("Join completely different tables");
        Table joindifftables=DMAT.join(tabela_2);
        System.out.println(joindifftables);
        
        // Join tables on Column
        System.out.println("Join tables on Column");
        Table a=new Table("a");
        Table b=new Table("b");
        Column a1=new Column("ID",Types.NUMERIC_INT);
        Column a2=new Column("Nome",Types.TEXT);
        Column b1=new Column("ID",Types.NUMERIC_INT);
        Column b2=new Column("Profissao",Types.TEXT);
        Object[] l1 = {1, "Lucas"};
        Object[] l2 = {2, "Maria"};
        Object[] l3 = {3, "Antonio"};
        Object[] l4 = {1, "Pintor"};
        Object[] l5 = {2, "Cantora"};
        Object[] l6 = {3, "Professor"};
        Object[] l7 = {3, "Acrobata"};
        a.addCol(a1);
        a.addCol(a2);
        b.addCol(b1);
        b.addCol(b2);
        ...
        Table res=a.joinOn(b,"ID","ID");
        System.out.println(res);
     
        
        // Cre;ate table to test where
        ...
        System.out.println("-----------------------------------------------------------------");
        System.out.println(tabela_4.checkWhereCondition("name > 10"));  // deve dar erro
        System.out.println("-----------------------------------------------------------------");
        ...
        System.out.println("-----------------------------------------------------------------");
        System.out.println(tabela_4.checkWhereCondition("age > 20 && name == \"ana\""));
        System.out.println("-----------------------------------------------------------------");

        
        //Checkout get without condition
        System.out.println("Checkout get without condition");
        //Table temp_2=tabela_4.getNewTable("age");
        //System.out.println(temp_2);
        //Checkout get with condition
        System.out.println("Checkout get with condition");
        ArrayList<String> temp_array=new ArrayList<String>();
        temp_array.add("age");
        Table temp_3=tabela_4.getNewTableWhere(temp_array, "age > 20");
        System.out.println(temp_3);
        temp_array.add("name");
        Table temp_4=tabela_4.getNewTableWhere(temp_array, "age > 2");
